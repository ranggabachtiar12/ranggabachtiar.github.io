...
if (url.searchParams.get('by') != null) {
  ...
  sender = "RanggaBachtiar";
}

let footer = document.getElementById("credit");
footer.innerHTML = sender;
footer.href = "https://www.instagram.com/angga_ocl/";

document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hai Kamu :)", "Aku ada pertanyaan nih buat kamu?", "question").then(function () {
    Swal.fire("Jawab yang jujur ya!").then(function () {
      Swal.fire("Tapi Ga Boleh bohong Loh Ya !!!", "", "error").then(function () {
            ...
            if (result.isConfirmed) {
              Swal.fire(`${sender} juga sayang banget sama ${nama}`).then(function () {
                Swal.fire({
                  ...
                  val = e.value
                  Swal.fire(`Makasih ya udah sayang sama ${sender} Walaupun Cuma ${val}%`).then(function () {
                    Swal.fire({
